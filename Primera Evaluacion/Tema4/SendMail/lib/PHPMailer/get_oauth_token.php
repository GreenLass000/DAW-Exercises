 ...
 * If no refresh token is obtained when running this resources,
 * revoke access to your app and run the js again.
 */
...
//If this automatic URL doesn't work, set it yourself manually to the URL of this js
