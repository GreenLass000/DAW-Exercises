 ...
 */
final class Version20240124083228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profesor (id INT AUTO_INCREMENT NOT NULL, instituto_id INT DEFAULT NULL, dni VARCHAR(9) NOT NULL, nombre VARCHAR(255) DEFAULT NULL, INDEX IDX_5B7406D96C6EF28 (instituto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
